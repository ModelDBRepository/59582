...
| Simulation   | set simulation parameters e.g. number of trees, simulation duration and time step |
| Display      | set 2D visualisation parameters                                         |
| Off/On       | turn 2D visualisation off or on (visualisation only occurs during creation of a single tree) |
...
| Draw         | draw 2D visualisation of one tree from currently created set of trees ("Display" must be on) |
